...
const ConcoursForm: React.FC = () => {
  ...
  const { data: existingConcours, isLoading: isLoadingConcours } =
    useConcoursDetail(parseInt(id || "0"), { enabled: isEditing });
  ...
  const isLoading =
    isLoadingConcours || createMutation.isPending || updateMutation.isPending;
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setFormData((prev) => ({
                  ...prev,
                  niveau: e.target.value as NiveauType,
                }))
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm"
            >
