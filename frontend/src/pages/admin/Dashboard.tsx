            ...
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-800 truncate">{item.name}</dt>
                    <dd className="flex items-baseline">
                      <div className={`text-2xl font-semibold ${
                        item.icon === NewspaperIcon ? "text-blue-600"
                          : item.icon === AcademicCapIcon ? "text-green-600"
                          : item.icon === TrophyIcon ? "text-purple-600"
                          : item.icon === FolderIcon ? "text-orange-600"
                          : "text-indigo-800"
                      }`}>
                        {item.value}
                      </div>
