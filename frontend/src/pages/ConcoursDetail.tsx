...
const ConcoursDetail = () => {
  ...
  const formattedOpenDate = useMemo(() => {
    ...
    try {
      return format(new Date(concours.dateOuverture), "dd MMMM yyyy", {
        locale: fr,
      });
    } catch {
  ...
  const formattedLimitDate = useMemo(() => {
    ...
    try {
      return format(new Date(concours.dateLimite), "dd MMMM yyyy", {
        locale: fr,
      });
    } catch {
  ...
  const handleDownloadFile = async () => {
    if (concours?.filePath) {
      try {
        ...
        link.setAttribute(
          "download",
          `${concours.nom.replace(/\s+/g, "_")}_document.pdf`,
        );
            ...
            >
              ...
              <div className="lg:col-span-1">
                <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 sticky top-6">
                  ...
                  {statusInfo && (
                    <div
                      className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold mb-6 ${statusInfo.color}`}
                    >
                  ...
                  <div className="space-y-3">
                    {concours.lienOfficiel && (
                      <Button
                        ...
                        onClick={() =>
                          window.open(concours.lienOfficiel, "_blank")
                        }
                      >
              ...
              <div className="lg:col-span-2">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 mb-8">
                  <div className="flex flex-wrap items-center gap-3 mb-4">
                    ...
                    <Badge
                      variant={
                        concours.status === "NATIONAL" ? "default" : "outline"
                      }
                      className="text-sm"
                    >
                      {concours.status}
                  ...
                  <div className="prose prose-lg max-w-none text-gray-700">
                    <p className="mb-6">
                      ...
                      {concours.status === "NATIONAL"
                        ? "national"
                        : "international"}
                      s'adresse aux étudiants de niveau{" "}
                      <strong>{concours.niveau.toLowerCase()}</strong>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                      ...
                      <ul className="space-y-2 text-blue-800">
                        <li>
                          • Consultez le site officiel pour connaître les
                          modalités exactes
                        </li>
                        <li>• Préparez les documents requis à l'avance</li>
                        <li>
                          • Respectez scrupuleusement la date limite
                          d'inscription
                        </li>
                        {concours.filePath && (
                          <li>
                            • Téléchargez la documentation complète pour plus de
                            détails
                          </li>
                        )}
                      </ul>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-6 mt-8">
                  ...
                  <p className="text-yellow-800">
                    Les informations présentées sur cette page sont fournies à
                    titre indicatif. Nous vous recommandons de toujours vérifier
                    les informations directement sur le{" "}
                    <strong>site officiel du concours</strong> pour vous assurer
                    de leur exactitude et connaître les dernières mises à jour.
                  </p>
                </div>
              </div>
            </motion.div>
