...
const contactMethods = [
  ...
  },
  {
    ...
    value: "+223 69 78 08 41",
    link: "tel:+223 69 78 08 41",
    color: "blue",
  },
  {
    icon: MapPin,
          ...
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-blue-200 max-w-2xl mx-auto leading-relaxed">
                Guidons l'excellence académique vers des horizons illimités
                depuis 2023
              </p>
            </motion.div>
          </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                <span className="text-purple-600">Présentation</span>
              </h2>
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Fondée en 2023, l'AMAME est une association bénévole dédiée à
                l'accompagnement des élèves et étudiants maliens dans leur
              ...
              >
                <Card className="p-6 md:p-8 shadow-xl border-0 rounded-2xl bg-gradient-to-br from-white to-purple-50">
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    <strong className="text-purple-600">AMAME</strong> est née
                    de la conviction profonde que chaque étudiant méritant
                    devrait avoir accès aux meilleures opportunités éducatives,
                    indépendamment de ses moyens financiers.
                  </p>
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    Nous nous engageons à{" "}
                    <strong>démocratiser l'accès à l'information </strong>
                    sur les bourses d'études, concours et orientations, et à
                    accompagner les étudiants maliens dans leur parcours
                    académique vers l'excellence.
                  </p>
              ...
              >
                <Card className="p-6 bg-gradient-to-br from-blue-500 to-purple-600 text-white text-center rounded-2xl border-0">
                  ...
                  <p className="text-blue-100 text-sm">
                    Un Mali où chaque étudiant talentueux peut réaliser son
                ...
                <Card className="p-6 bg-gradient-to-br from-emerald-500 to-green-600 text-white text-center rounded-2xl border-0">
                  ...
                  <p className="text-emerald-100 text-sm">
                    Accompagner les étudiants vers l'excellence académique par
                ...
                <Card className="p-6 bg-gradient-to-br from-amber-500 to-orange-600 text-white text-center rounded-2xl border-0 col-span-2">
                  ...
                  <p className="text-amber-100 text-sm">
                    Plusieurs centaines d'étudiants accompagnés, plusieurs
                    milliers de bourses obtenues.
                  </p>
                </Card>
              </motion.div>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Des services complets pour accompagner les étudiants à chaque
